export const PAGINATION_TEMPLATE_EX = `
<div class="pagination-box">
    ...
    <div class="pagination-controllers">
        ...
        <div class=" pagination-pages">
            ...
            <button *ngIf="hasPrevious(maxPage,page) && show_numbers" [disabled]="true" (click)="false" class="btn btn-default hasPrevious">...</button>
            ...
            <button *ngIf="hasNext(maxPage,page) && show_numbers" [disabled]="true" (click)="false" class="btn btn-default hasNext">...</button>
