...
export const environment = {
    ...
    silent: false,
    api:{
        James: { domain: "https://jamesapi.spenn.com"},
        Blockbonds: { domain: "https://bb-prod-ase-api.spenninternal.com"}
    },
    server:{
        IdentityServer: { domain: "https://bb-prod-ase-idsrv.spenninternal.com"}
    },
    bbAuth: {
        clientID: "James",
        clientSecret: "1234",
        audience: "AdminApi",
        redirectUrl: "https://james.spenn.com"
    },
