export const environment = {
    ...
    silent: false,
    api:{
        James : { domain: "https://bb-qa3-jamesapi.azurewebsites.net"},
        Blockbonds : { domain: "https://bb-qa3-api.azurewebsites.net"}
    },
    server:{
        IdentityServer : { domain: "https://bb-qa3-idsrv.azurewebsites.net"}
    },
    bbAuth: {
        clientID: "James",
        clientSecret: "1234",
        audience: "AdminApi",
        redirectUrl: "https://bb-qa3-james.azurewebsites.net"
    },
