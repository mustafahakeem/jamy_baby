...
export const environment = {
    ...
    silent: false,
    api:{
        James : { domain: "https://bb-ci-jamesapi.azurewebsites.net"},
        Blockbonds : { domain: "https://bb-ci-api.azurewebsites.net"}
    },
    server:{
        IdentityServer : { domain: "https://bb-ci-idsrv.azurewebsites.net"}
    },
    bbAuth: {
        clientID: "James",
        clientSecret: "1234",
        audience: "AdminApi",
        redirectUrl: "https://bb-ci-james.azurewebsites.net"
    },
