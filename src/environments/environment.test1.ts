...
export const environment = {
    ...
    silent: false,
    api:{
        James : { domain: "https://bb-test1-jamesapi.azurewebsites.net"},
        Blockbonds : { domain: "https://bb-test1-api.azurewebsites.net"}
    },
    server:{
        IdentityServer : { domain: "https://bb-test1-idsrv.azurewebsites.net"}
    },
    bbAuth: {
        clientID: "James",
        clientSecret: "1234",
        audience: "AdminApi",
        redirectUrl: "https://bb-test1-james.azurewebsites.net"
    },
