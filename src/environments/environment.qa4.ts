export const environment = {
    ...
    silent: false,
    api:{
        James : { domain: "https://bb-qa4-jamesapi.azurewebsites.net"},
        Blockbonds : { domain: "https://bb-qa4-api.azurewebsites.net"}
    },
    server:{
        IdentityServer : { domain: "https://bb-qa4-idsrv.azurewebsites.net"}
    },
    bbAuth: {
        clientID: "James",
        clientSecret: "1234",
        audience: "AdminApi",
        redirectUrl: "https://bb-qa4-james.azurewebsites.net"
    },
